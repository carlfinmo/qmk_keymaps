...
#define LT2_TAB LT(_L2, KC_TAB)
#define LT2_SPC LT(_L2, KC_SPC)
#define LT1_RET LT(_L1, KC_ENT)
...
[_QW] = LAYOUT(
  ...
  KC_LSFT, LCTL_T(KC_Z),    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  RCTL_T(KC_SLSH), KC_SPC,
  KC_LCTL, KC_LALT, KC_LEFT, KC_RIGHT,  LT2_TAB, KC_SPC,  LT1_RET, KC_UP, KC_DOWN, KC_LGUI,   KC_APP
),
[_CM] = LAYOUT(
  KC_ESC,  KC_Q,    KC_W,    KC_F,    KC_P,    KC_G,    KC_J,    KC_L,    KC_U,    KC_Y,    KC_SCLN,    LT3_MINUS,
  KC_BSPC, KC_A,    KC_R,    KC_S,    KC_T,    KC_D,    KC_H,    KC_N,    KC_E,    KC_I,    KC_O, KC_QUOT,
  KC_LSFT, LCTL_T(KC_Z),    KC_X,    KC_C,    KC_V,    KC_B,    KC_K,    KC_M,    KC_COMM, KC_DOT,  RCTL_T(KC_SLSH), KC_SPC,
  KC_LCTL, KC_LALT, KC_LEFT, KC_RIGHT,  LT2_TAB, KC_SPC,  LT1_RET, KC_UP, KC_DOWN, KC_LGUI,   KC_APP
),
