...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    KC_P1,   KC_P2,   KC_P3,   KC_PENT,      KC_LSFT, LCTL_T(KC_NUBS), KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_K,    KC_M,    KC_COMM, KC_DOT,  LCTL_T(KC_SLSH), KC_RSFT, MO(_L1),            KC_UP,
    ...
    KC_P1,   KC_P2,   KC_P3,   KC_PENT,      KC_LSFT, LCTL_T(KC_NUBS), KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  LCTL_T(KC_SLSH), KC_RSFT, MO(_L1),            KC_UP,
