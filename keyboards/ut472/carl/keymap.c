...
#define FIRST_LAYER _QW
#define LAST_LAYER _L3
...
[_L1] = LAYOUT( /* Right */
  ...
  KC_DEL , RGB_TOG, RGB_MOD, RGB_VAI, RGB_VAD, _______,  KC_MINS, KC_EQL,  KC_LBRC, KC_RBRC, KC_BSLS, KC_GRV,
  _______, KC_F11,  KC_F12,  KC_F13,  KC_F14,  KC_F15,   KC_UNDS, KC_PLUS, KC_LCBR, KC_RCBR, KC_PIPE, KC_TILD,
...
[_L2] = LAYOUT( /* Left */
  ...
  KC_DEL , _______, _______, _______, _______, _______, _______, KC_EQL, KC_PLUS, KC_LEFT_CURLY_BRACE, KC_RIGHT_CURLY_BRACE, KC_PIPE,
